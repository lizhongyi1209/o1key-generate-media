...
Use that `public_url` in Seedance or Kling reference fields. Never put the O1Key API key in the OSS upload request, log the presigned URL, or construct the public URL manually.
